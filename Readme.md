...
Ini adalah sebuah sistem cerdas yang dirancang untuk mendeteksi, melacak, dan menghitung telur secara otomatis menggunakan umpan video dari webcam. Proyek ini dibangun dengan teknologi *computer vision* modern seperti **YOLOv8**, **OpenCV**, dan pustaka **Supervision**.
...
-    **Visualisasi Real-Time**: Tampilan antarmuka yang informatif, lengkap dengan kotak pembatas (*bounding box*), ID pelacakan, garis virtual, dan total hitungan yang selalu diperbarui.
